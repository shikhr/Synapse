...
const CommentCard = ({ id }: CommentCardProps) => {
  ...
  return (
    <FadeInView className="grid grid-rows-auto grid-cols-[auto_1fr] place-items-center w-full text-text-primary-dark gap-x-4 gap-y-3 px-4 py-4 border-b border-text-secondary-dark">
      <Link
